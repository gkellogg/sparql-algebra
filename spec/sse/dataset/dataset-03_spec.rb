...
describe "W3C test" do
  context "dataset" do
    ...
    example "dawg-dataset-03" do
      ...
      expected = [
          {
            :s => RDF::URI("http://example/x"), :p => RDF::URI("http://example/p"), :o => RDF::Literal(1), :g => graph_uris[:g1]
          },
          {
            :s => RDF::URI("http://example/a"), :p => RDF::URI("http://example/p"), :o => RDF::Literal(9), :g => graph_uris[:g1]
          },
      ]
